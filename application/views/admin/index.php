		  ...
		  <div class="col-md-2">
		  	<div class="sidebar content-box" style="display: block;">
                <ul class="nav">
                    ...
                    <li><a href="calendar.html"><i class="glyphicon glyphicon-calendar"></i> Data Mahasiswa</a></li>
                    <li><a href="stats.html"><i class="glyphicon glyphicon-stats"></i> Data Dosen</a></li>
